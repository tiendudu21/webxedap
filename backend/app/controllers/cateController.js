...
const cateController = {
    getAllCate: async (req, res) => {
        const page = req.body.page || 1;  // Trang hiện tại (nếu không có, sử dụng trang 1)
        const limit = req.body.limit || 10; // Số lượng kết quả trên mỗi trang (nếu không có, sử dụng giá trị mặc định là 10)
        ...
        try {
            // Thực hiện truy vấn cơ sở dữ liệu để lấy danh mục với sự hỗ trợ của paginate
